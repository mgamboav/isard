...
python3 -m grpc_tools.protoc --proto_path=. ./engine/grpc/proto/base.proto --python_out=. --grpc_python_out=.
python3 -m grpc_tools.protoc --proto_path=. ./engine/grpc/proto/bases_stream.proto --python_out=. --grpc_python_out=.
