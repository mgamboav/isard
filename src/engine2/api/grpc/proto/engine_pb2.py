...
# source: api/grpc/proto/engine.proto
...
EngineIsAliveRequest = _reflection.GeneratedProtocolMessageType('EngineIsAliveRequest', (_message.Message,), {
  'DESCRIPTOR' : _ENGINEISALIVEREQUEST,
  '__module__' : 'api.grpc.proto.engine_pb2'
  # @@protoc_insertion_point(class_scope:engine.EngineIsAliveRequest)
  })
_sym_db.RegisterMessage(EngineIsAliveRequest)

EngineIsAliveResponse = _reflection.GeneratedProtocolMessageType('EngineIsAliveResponse', (_message.Message,), {
...
EngineStatusRequest = _reflection.GeneratedProtocolMessageType('EngineStatusRequest', (_message.Message,), {
