...
python3 -m grpc_tools.protoc --proto_path=. ./api/grpc/proto/domain_enums.proto --python_out=. --grpc_python_out=.
...
python3 -m grpc_tools.protoc --proto_path=. ./api/grpc/proto/hypervisor.proto --python_out=. --grpc_python_out=.
