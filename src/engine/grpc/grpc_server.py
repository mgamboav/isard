...
class GrpcServerBase(object):
    ...
    def start_server(self):
        ...
        # desktops_stream_pb2_grpc.add_DesktopsStreamServicer_to_server(DesktopsStreamServicer(self.app),
        #                                                               self.engine_grpc_server)
        # template_pb2_grpc.add_TemplateServicer_to_server(TemplateServicer(self.app), self.engine_grpc_server)
        # templates_stream_pb2_grpc.add_TemplatesStreamServicer_to_server(TemplatesStreamServicer(self.app),
        #                                                                 self.engine_grpc_server)
...
class GrpcServer(GrpcServerBase):
