...
# source: engine/grpc/proto/media_stream.proto
...
MediaStreamRequest = _reflection.GeneratedProtocolMessageType('MediaStreamRequest', (_message.Message,), dict(
  DESCRIPTOR = _MEDIASTREAMREQUEST,
  __module__ = 'engine.grpc.proto.media_stream_pb2'
  # @@protoc_insertion_point(class_scope:templates_stream.MediaStreamRequest)
  ))
_sym_db.RegisterMessage(MediaStreamRequest)

MediaStreamResponse = _reflection.GeneratedProtocolMessageType('MediaStreamResponse', (_message.Message,), dict(
