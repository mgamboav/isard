...
_ENGINE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='engine.Engine.TemplateFromDesktop',
    index=13,
    containing_service=None,
